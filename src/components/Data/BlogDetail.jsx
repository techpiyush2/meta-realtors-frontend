...
const imgPath = environment.baseUrl + 'upload/blogs/'
  ...
  return (
    <div><div className="max-w-4xl flex items-center justify-start h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
    ...
    <div id="profile" className="w-full lg:w-3/6 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
	

    <div className="p-4 md:p-12 text-center lg:text-left">
        <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center" ></div>
        
        <h1 className="text-3xl font-bold pt-8 lg:pt-0 text-blue">{props.title}</h1>
        <div className="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
        <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start "> Type : {props.type}</p>
        <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">Location : Punjab</p>
        ...
        <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-evenly text-blue">
